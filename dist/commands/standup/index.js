...
import { getJobs, getAssignments, getUpdates, saveUpdates } from '../../lib/store.js';
...
export default class Standup extends Command {
    ...
    async run() {
        ...
        const alreadyDone = existingUpdates.some(u => u.member === identity.handle && u.message.startsWith('📋 Yesterday:'));
        if (alreadyDone) {
